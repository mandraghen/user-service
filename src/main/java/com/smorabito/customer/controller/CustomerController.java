...
public class CustomerController {
    ...
    @Operation(
            ...
            description = "Create or update a customer. If the customer exists, it will be updated; otherwise, " +
                    ...
                    "ignored and autogenerated. It updates the address, but always update the related entity " +
                    "if exists, otherwise always create a new one, ignoring the address id in the body.",
            responses = {
